...
- `unlockAt` — วัน-เวลาที่จะปลดล็อกเว็บไซต์ (รูปแบบ `YYYY-MM-DDTHH:MM:SS`) ก่อนถึงเวลานี้ผู้เข้าชมจะเห็นแค่หน้านับถอยหลัง เข้าเว็บไม่ได้
...
## ฟีเจอร์หลัก
- หน้านับถอยหลังปลดล็อก (Lock Screen) บล็อกไม่ให้เข้าเว็บได้จนกว่าจะถึงวัน-เวลาที่ตั้งไว้ใน `unlockAt`
